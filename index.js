// Script by Pepe
// ɪᴛ's ᴍᴇ ғᴀᴢɪʟ | 𝙳𝙾𝙽'𝚃 𝙲𝙷𝙰𝙽𝙶𝙴 𝙲𝚁𝙴𝙳𝙸𝚃𝚂🙂
// ©Pepe Bot 
const {
...
const asw1 = 'https://i.imgur.com/WlfqtaE.jpeg'
...
autoketik = false;
prefixStatus = true;
targetpc = "994405874080"; 
owner = "994405874080"; 
fakeyoi = "ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ғᴀᴢᴢꫂ₀₁₁"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`994405874080@s.whatsapp.net`]
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/994405874080?text=hello`}}})
		}*/
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Pepe Bot Ofc.`, "footerText": "*_ɪᴛ's ᴍᴇ ғᴀᴢɪʟ_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`ɪᴛ's ᴍᴇ ғᴀᴢɪʟ 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
...
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `pepe`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/994405874080?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nɪᴛ's ᴍᴇ ғᴀᴢɪʟ😎. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.imgur.com/WlfqtaE.jpeg",
                "thumbnail": fake,
                "sourceUrl": ``
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/994405874080`,
                "mediaType": "10",
                "mediaUrl": `wa.me/994405874080`,
                "thumbnailUrl": "https://i.imgur.com/WlfqtaE.jpeg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/994405874080`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "994405874080@s.whatsapp.net";
...
*Thank you for registering in the ɪᴛ's ᴍᴇ ғᴀᴢɪʟ😎 Database*
...
*「 ɪᴛ's ᴍᴇ ғᴀᴢɪʟ 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered ɪᴛ's ᴍᴇ ғᴀᴢɪʟ*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `ɪᴛ's ᴍᴇ ғᴀᴢɪʟ`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "994405874080@s.whatsapp.net"
        dtod = '994405874080'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
│      
│
│  ▢ *ᴅᴇᴠᴇʟᴏʟᴇʀ* : ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ғᴀᴢᴢꫂ₀₁₁
│  ▢ *ᴏᴡɴᴇʀ* :  ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ғᴀᴢᴢꫂ₀₁₁
│  ▢ *ᴠᴇʀsɪᴏɴ* : 1.0
│  ▢ *ᴍᴏᴅᴇ* : ᴘᴜʙʟɪᴄ
│  ▢ *ᴘʀᴇғɪx* : [# .]
...
│
│  ❑ *ɢɪᴛʜᴜʙ ʟɪɴᴋ* :
│  ath onnum nan arkum kodukarilla bro
│  
│  ❑ *ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ* :
│  athonnum illa tto
│
│  ❑ *ʙᴏᴛ ɢʀᴏᴜᴘ ʟɪɴᴋ*
│  groupil vannu alamb kalikan alle 
│
│  ❑ *ᴏᴡɴᴇʀ* : 
│  owner nan thanne 😁
│
...
│✨ wa.me/${dtod.split('@')[0]}
╰───────────────
 © ᴄᴏᴅᴇᴅ ʙʏ ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ғᴀᴢᴢꫂ₀₁₁
 `
...
case 'bugreport':
              ...
              xeon.sendMessage('994405874080@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
`
sendButMessage(from, menu, `ɪᴛ's ᴍᴇ ғᴀᴢɪʟ`, [
          {
            buttonId: `command`,
            buttonText: {
...
case 'hacked':
  if (!mek.key.fromMe) return;
              ...
              if (args.length < 1) return reply('The text?')
              reply('Otw Hack')
                tessgc = await getBuffer(`https://i.imgur.com/WlfqtaE.jpeg`)
...
case "intake3": // by pepe
      ...
      case "group":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `GROUP SETTING`, `Please choose one/nꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ғᴀᴢᴢꫂ₀₁₁`, [
          {
            buttonId: `opengc`,
            buttonText: {
              displayText: `OPEN`,
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'ɪᴛ's ᴍᴇ ғᴀᴢɪʟ', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `ɪᴛ's ᴍᴇ ғᴀᴢɪʟ`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 ɪᴛ's ᴍᴇ ғᴀᴢɪʟ BROADCASTING 」*\n\n${body.slice(4)}`})
}
